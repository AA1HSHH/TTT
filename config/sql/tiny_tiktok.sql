...
INSERT INTO `t_user`(`id`,`name`,`passwd`) VALUES(1,'DOU1','1234561');
INSERT INTO `t_user`(`id`,`name`,`passwd`) VALUES(2,'DOU2','1234562');
INSERT INTO `t_user`(`id`,`name`,`passwd`) VALUES(3,'DOU3','1234563');
INSERT INTO `t_user`(`id`,`name`,`passwd`) VALUES(4,'DOU4','1234564');
INSERT INTO `t_user`(`id`,`name`,`passwd`) VALUES(5,'DOU5','1234565');

INSERT INTO `t_video`(`id`,`author_id`,`title`,`publish_time`,`play_url`,`cover_url`)
VALUES (1,1,'DOU1 whale','2023-02-11 11:09:17',
        'https://prod-streaming-video-msn-com.akamaized.net/aa5cb260-7dae-44d3-acad-3c7053983ffe/1b790558-39a2-4d2a-bcd7-61f075e87fdd.mp4',
        'https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAOElb0.img');
INSERT INTO `t_video`(`id`,`author_id`,`title`,`publish_time`,`play_url`,`cover_url`)
VALUES (2,1,'DOU1 beach','2023-02-11 11:12:17',
        ...
        'https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAOEcdS.img');
