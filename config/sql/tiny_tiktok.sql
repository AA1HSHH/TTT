...
INSERT INTO `t_user`(`id`,`name`,`passwd`,`avatar`,`work_count`,`background_image`,`signature`,`follow_count`,`follower_count`) VALUES(1,'DOU1','$2a$14$VSYjOFVVrZIiKhH3QKBXL.PjXQ2DqCj.i9Otzdpe.tLqNcaCTI49e','https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAOEiFs.img',2,'https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAOEiFs.img','Carpe Diem.',2,2);
INSERT INTO `t_user`(`id`,`name`,`passwd`,`avatar`,`follow_count`,`follower_count`) VALUES(2,'DOU2','$2a$14$SxKboOBj8/yUlIFnrpkADuEyGMW0h/yuRoWe9mP.4hkb7.0FSptMW','https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAOEa3q.img',1,1);
INSERT INTO `t_user`(`id`,`name`,`passwd`,`avatar`,`follow_count`,`follower_count`) VALUES(3,'DOU3','$2a$14$uksl0e5kiYo5ZPxAabxhQOOpOoK9VoHOI2qM8eoiqRSptDLdDUjPi','https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AAOEhRJ.img',1,1);
...
INSERT INTO `t_follow`(`user_id`, `fans_id`) VALUES (2,1);
INSERT INTO `t_follow`(`user_id`, `fans_id`) VALUES (1,3);
INSERT INTO `t_follow`(`user_id`, `fans_id`) VALUES (3,1);
INSERT INTO `t_message`(`id`,`from`,`to`,`content`,`create_time`) VALUES (1,2,1,'hello',1677316912576);
INSERT INTO `t_message`(`id`,`from`,`to`,`content`,`create_time`) VALUES (2,3,1,'hi',1677316912572);